              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`mt-1 block w-full px-3 py-2 border rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent bg-white/90 backdrop-blur-sm ${errors.email ? 'border-red-300' : 'border-blue-800/50'
                      }`}
                ...
                <div>
                  ...
                  <div className="mt-1 relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`block w-full px-3 py-2 pr-10 border rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent bg-white/90 backdrop-blur-sm ${errors.password ? 'border-red-300' : 'border-blue-800/50'
                        }`}
